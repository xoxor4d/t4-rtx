...
function imgui.project()
	project "imgui"
		...
		files {
            ...
            path.join(imgui.source, "imgui_impl_dx9.cpp"),
            path.join(imgui.source, "imgui_impl_dx9.h"),
            path.join(imgui.source, "imgui_impl_win32.cpp"),
            path.join(imgui.source, "imgui_impl_win32.h"),
		}
