...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          StyleColorsDevgui(ImGuiStyle* = NULL);
    IMGUI_API void          StyleColorsLightGreen(ImGuiStyle* = NULL);
    ...
    IMGUI_API bool          IsItemHoveredDelay(float delay_in_seconds = 0.0f);
